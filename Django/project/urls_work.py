...
urlpatterns = [
    ...
    path('work_detail_remove/<int:job_detail_id>', views_work.work_detail_remove, name="work_detail_remove"),
    path('work_detail_update/<int:job_detail_id>', views_work.work_detail_update, name="work_detail_update"),
